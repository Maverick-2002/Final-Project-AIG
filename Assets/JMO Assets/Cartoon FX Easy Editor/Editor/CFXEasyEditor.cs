...
//		GUILayout.Space(6);
	...
	private void SubModuleCopy(SerializedObject source, SerializedObject dest)
	{
		...
		if(source.FindProperty("SubModule.subEmitterDied").objectReferenceValue != null)
		{
			//Duplicate sub Particle Emitter
			copy = (GameObject)Instantiate((source.FindProperty("SubModule.subEmitterDied").objectReferenceValue as ParticleSystem).gameObject);
			...
			//Assign as sub Particle Emitter
			dest.FindProperty("SubModule.subEmitterDied").objectReferenceValue = copy;
		}
